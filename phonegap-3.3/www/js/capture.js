var capture = {
    ...
    localStorage.queueList = JSON.stringify(queueList);  // Add Queue
        ...
        // This is painful for checking online status, but after client testing this
        // does perform better on most Android and some iOS devices
        // with no reported bugs.  ~April 2014
    ...
    updateDetailsPage: function (itemID, img) {
        ...
        // Todo: centralize id handling to core.
    ...
    appendImgToDetailsPage: function (pageID, img) {
        ...
        var index;
        var abc_arr = ['a','b','c','a']; // When C, +1 returns a, and still indexOf('a')==0
    ...
    uploadQueue: function () {
        ...
        api.uploadImage(queuedID, queuedImg)
            .done(function () {
                ...
                requests.getCounter();
                // shift() will remove the request without checking how many images were uploaded
                queueList.shift();
                localStorage.queueList = JSON.stringify(queueList);  // Update local Queue
