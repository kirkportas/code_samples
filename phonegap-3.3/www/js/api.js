...
var api = {
    ...
    /*
     ...
     curl -k -X POST -H "Content-Type: application/json" -d '{ "username" : "xx", "password" : "xx" }' https://site.com/api-get-token/
     curl -k -X GET https://clientsite.com/inventory/ -H 'Authorization: Token 4e85f3897d4a404493518296c756c94cea64c2d8'
     curl -k -X GET https://clientsite.com/image_requests/ -H 'Authorization: Token 4e85f3897d4a404493518296c756c94cea64c2d8'
     */
    ...
    getHeadersArray: function (filename) {
        ...
        var headers = {'Access-Control-Allow-Origin': '*',
            ...
            //redact. Phonegap settings magic
            };
        if (device.platform == "Android") {
            //redact. Android API magic. <^> -_- <^> to Android;
        }
    ...
    // uploadImageWithMessage() cut from features. Available in git history
};