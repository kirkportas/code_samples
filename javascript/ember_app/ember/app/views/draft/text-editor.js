...
// This file controls the CKEDITOR initialization and config.
...
export default Ember.TextArea.extend({
    ...
    _setupInlineEditor: function () {
        ...
        CKEDITOR.once('instanceReady', function (e) {
            ...
            editor.setReadOnly(this.get('isReadOnly'));  // Status for 'can user edit?'
            editor.setReadOnly(this.get('isFinalDraft'));// Status for 'can user edit?'
    ...
    _getEditorConfig: function () {     // This replaces CKEditor config files
        var config = {
            ...
            title: false, // hide hover title. this comma prevents an occasional bug, leave it.
        };
