...
export default DraftController.extend({
    ...
    actions: {
        ...
        next: function () { // This Ember Promise logic has been refactored 
                            // from ~150 to 80 lines, and it's stable.
            ...
            draft.get('review')
                .then( function(review) { review.get('annotations')
                    .then( function(annotations) {
                        ...
                        //TODO this calls draft.get twice can be improved

                        //// Update associated review and essay, then redirect
        ...
        //// For 'Save Essay' button in review settings box. Button Removed.
